<?php
if ( ! function_exists( 'untoldstories_color_luminance' ) ) :
	/**
	 ...
	 */
	function untoldstories_color_luminance( $color, $percent ) {
		// Remove # if provided
		if ( '#' === $color[0] ) {
...
if ( ! function_exists( 'untoldstories_hex2rgba' ) ) :
	/**
	 ...
	 * @return string
	 */
	function untoldstories_hex2rgba( $color, $opacity = false ) {

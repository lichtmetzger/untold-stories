<?php
if ( ! class_exists( 'Untoldstories_Widget_About_Mod' ) ):
    class Untoldstories_Widget_About_Mod extends WP_Widget {
        ...
        function __construct() {
            ...
            $control_ops = array();
            parent::__construct( 'untoldstories-about_mod', $name = esc_html__( 'Theme - About Me (no crop)', 'untold-stories' ), $widget_ops, $control_ops );
        }
        ...
        function widget( $args, $instance ) {
            ...
            if ( $image ) {
                ...
                echo sprintf( '<p class="widget_about_avatar"><img src="%s" class="%s" alt="%s" /></p>',
                    esc_url( untoldstories_get_image_src( $image, 'full' ) ),
    ...
    register_widget( 'Untoldstories_Widget_About_Mod' );
